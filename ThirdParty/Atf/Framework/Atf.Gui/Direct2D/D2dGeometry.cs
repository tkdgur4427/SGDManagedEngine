...
#if WITH_SGD // version up .net framework to 4.5.2
                var tempHeight = rect.Bottom - rect.Top;
                var tempWidth = rect.Right - rect.Left;
                return new RectangleF(rect.Left, rect.Top, tempWidth, tempHeight);
#else
